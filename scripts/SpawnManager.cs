...
public partial class SpawnManager : Node
{
    ...
    public override void _Process(double delta)
    {
        ...
        {
            // Temporarily disable continuous spawning from _Process
            ...
            // }
            // initialSpawnTimer = SPAWN_TIMER;
            // Still call RemoveOutOfSightObjects if you re-enable it later
            // foreach (var kvp in spawnedObjects)
            // {
            // 	RemoveOutOfSightObjects(kvp.Value.objects);
            // }
        }
    }
